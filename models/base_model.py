...
class ModelFactory:
    ...
    def get_by_name(model_name, *args, **kwargs):
        ...
        if model_name == 'FOAFCGAN_single':
            from .FOAFCGAN_gaussian import FOAFCGAN_single_guassian
            model = FOAFCGAN_single_guassian(*args, **kwargs)
        elif model_name == 'FOAFCGAN_alternate_training':
            from .FOAFCGAN_alternate_training import FOAFCGAN_alternate_training
            model = FOAFCGAN_alternate_training(*args, **kwargs)
        elif model_name == 'FOAFCGAN_alternate_training_1':
            from .FOAFCGAN_alternate_training_1 import FOAFCGAN_alternate_training
            model = FOAFCGAN_alternate_training(*args, **kwargs)
        else:
...
class BaseModel(object):
    ...
    def __init__(self, opt):
        ...
        self._device = torch.device('cuda:' + str(opt.gpu_ids[0]))
